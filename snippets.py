...
def snippet_4():
    ...
    # first statement is true but the second statement is not true since we are using the and opperator both statements have to be true in order for the print statement to = not true
snippet_4()
def snippet_5():
